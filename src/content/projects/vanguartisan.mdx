...
Not illustration. Not replacement. Something more specific — using the systematic properties of these tools (the way they weight language, the way they interpolate between training references, the way they fail) as material in themselves.
...
<Figure
  src="/images/vanguartisan/exposure-series-overview.jpg"
  alt="Overview of the Exposure-series matrix structure"
  caption="The 12×12 matrix — twelve figures, twelve makers, 144 pieces."
  size="full"
/>

...
The first generation pass used [fal.ai](https://fal.ai). The second used the [Black Forest Labs](https://bfl.ai) playground directly. The results were not comparable — BFL produces meaningfully better output for this kind of work, and the platform exposes the parameters that actually matter.
...
<img src="/images/writing/what-if-the-photographer-had-found-them-first/Caesar-R001.png" style="zoom:33%;" />
...
<div style="display: flex; gap: 1rem;">
  <img src="/images/writing/what-if-the-photographer-had-found-them-first/Caesar-R002.png" style="width: 33%;"/>
  <img src="/images/writing/what-if-the-photographer-had-found-them-first/Caesar-R003.png" style="width: 33%;"/>
  <img src="/images/writing/what-if-the-photographer-had-found-them-first/Caesar-R004.png" style="width: 33%;"/>
</div>
